...
loadScript('/yvann_test_web_async/marked.min.js').catch((e) => {
  console.log(e)
})
loadScript('/yvann_test_web_async/purify.min.js').catch((e) => {
  console.log(e)
})

const categories = ["🧪 Yvann Tests"];
app.registerExtension({
	name: "Yvann_test.HelpPopup",
	async beforeRegisterNodeDef(nodeType, nodeData) {
   
  if (app.ui.settings.getSettingValue("Yvann_test.helpPopup") === false) {
    return;
    }
		try {
        ...
        if (nodeData?.category?.startsWith(category)) {
			...
			console.error("Error in registering Yvann_test.HelpPopup", error);
		}
	},
});
